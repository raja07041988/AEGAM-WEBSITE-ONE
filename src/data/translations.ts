...
export const TRANSLATIONS: Record<Language, Translations> = {
  ...
  ta: {
    ...
    whyAegam: {
      ...
      pillar3Desc: 'ஏகனானேகன், வளரிவன், அருளாட்சி மற்றும் ஈஓஎஸ் கேட்வே ஆகியவற்றுக்கு இடையேயான தெளிவான செயல்பாட்டுப் பிரிவு.',
