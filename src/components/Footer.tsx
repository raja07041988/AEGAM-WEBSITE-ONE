  ...
  return (
    <footer className={`border-t transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12 lg:py-16">
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-5 gap-8 lg:gap-12">
          ...
          <div className="lg:col-span-2 space-y-4">
            <div className="flex items-center gap-3">
              <div className="w-10 h-10 rounded-lg bg-[#241E0F] border border-[#D4AF37]/40 flex items-center justify-center">
              ...
              <div>
                ...
                <p className="text-[10px] text-[#D8CCA8] uppercase tracking-widest font-mono">
                  {t.footer.ecosystemSummary}
                </p>
              </div>
            </div>

            <p className="text-xs text-[#D8CCA8] leading-relaxed max-w-md">
            ...
            <div className="pt-2 flex flex-wrap items-center gap-3 text-xs">
              <span className="px-2.5 py-1 bg-[#18140B] border border-[#4A3B18] rounded text-[11px] font-mono text-[#D4AF37]">
                AEGAM.IN ({isTa ? 'சுற்றுச்சூழல்' : 'Ecosystem'})
              </span>
              <span className="text-[#4A3B18]">•</span>
              <a
                href="https://www.aeganai.in"
                target="_blank"
                rel="noopener noreferrer"
                className="px-2.5 py-1 bg-[#18140B] border border-[#4A3B18] hover:border-[#D4AF37]/60 rounded text-[11px] font-mono text-[#D4AF37] transition-colors inline-flex items-center gap-1"
              >
          ...
          {/* Quick Links Column */}
          <div>
            <h4 className="text-xs font-bold uppercase tracking-wider text-[#D4AF37] mb-4 border-b border-[#4A3B18] pb-2">
              {t.footer.quickLinks}
            </h4>
          ...
          <div>
            ...
            <ul className="space-y-2.5 text-xs text-[#D8CCA8]">
              <li className="flex items-start gap-1.5">
                <span className="text-[#D4AF37] font-bold">•</span>
                <div>
                  <span className="text-white font-semibold block">{isTa ? 'ஏகம் டிரஸ்ட்' : 'AEGAM TRUST'}</span>
                  <span className="text-[10px] text-[#D8CCA8]/80">{isTa ? 'நிர்வாக அறக்கட்டளை' : 'Governance & Stewardship'}</span>
                </div>
              </li>
              <li className="flex items-start gap-1.5">
                <span className="text-[#D4AF37] font-bold">•</span>
                <div>
                  <span className="text-white font-semibold block">{isTa ? 'ஏகன் அநேகன் இண்டஸ்ட்ரீஸ்' : 'Aegan Anegan Industries'}</span>
                  <span className="text-[10px] text-[#D8CCA8]/80">{isTa ? 'இயந்திர உற்பத்தி' : 'Machinery Manufacturing'}</span>
                </div>
              </li>
              <li className="flex items-start gap-1.5">
                <span className="text-[#D4AF37] font-bold">•</span>
                <div>
                  <span className="text-white font-semibold block">{isTa ? 'வாலறிவன் இண்டஸ்ட்ரி' : 'Valarivan Industry'}</span>
                  <span className="text-[10px] text-[#D8CCA8]/80">{isTa ? 'விற்பனை & வணிகம்' : 'Sales & Distribution'}</span>
                </div>
              </li>
              <li className="flex items-start gap-1.5">
                <span className="text-[#D4AF37] font-bold">•</span>
                <div>
                  ...
                  <span className="text-[10px] text-[#D8CCA8]/80">{isTa ? 'கொள்முதல் & விநியோகம்' : 'Procurement & Supply Chain'}</span>
                </div>
              </li>
            </ul>
          </div>
            ...
            <ul className="space-y-2.5 text-xs text-[#FAF3EB]">
              ...
              <li className="pt-2">
                <a
                  ...
                  target="_blank"
                  rel="noopener noreferrer"
                  className="px-3 py-2 bg-[#18140B] border border-[#4A3B18] rounded text-xs text-[#D4AF37] hover:bg-[#241E0F] transition-colors block text-center font-medium"
                >
                  www.aeganai.in
                </a>
              </li>
        ...
        {/* Philosophy Strip */}
        <div className="mt-12 pt-8 border-t border-[#4A3B18] p-6 bg-[#18140B]/80 rounded-xl border">
          <div className="flex flex-col lg:flex-row items-center justify-between gap-4 text-center lg:text-left">
            <div>
              ...
              <p className="text-xs text-[#D8CCA8] mt-1 max-w-3xl">
            ...
            <button
              ...
              className="shrink-0 px-5 py-2.5 bg-[#C5A059] hover:bg-[#D4AF37] text-[#18140B] font-bold text-xs rounded transition-colors"
            >
              {t.nav.getStarted}
            </button>
          </div>
      ...
      <div className="bg-[#100D06] border-t border-[#4A3B18] py-4 text-[10px] uppercase tracking-[0.2em] text-[#D8CCA8]">
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex flex-col sm:flex-row items-center justify-between gap-3">
          <p>© {new Date().getFullYear()} {t.footer.rights}</p>
          <div className="flex items-center gap-6 text-[10px] text-[#D8CCA8] font-medium uppercase tracking-[0.2em]">
