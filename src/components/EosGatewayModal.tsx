    ...
    <div className="fixed inset-0 z-50 flex items-center justify-center p-4 bg-black/80 backdrop-blur-sm transition-opacity">
      ...
      >
          ...
          <div className="flex items-center gap-3">
            ...
            <div>
              <div className="flex items-center gap-2">
                <span className={`font-bold tracking-wider ${isDark ? 'text-white' : 'text-[#2B1015]'}`}>
        ...
        <div className="p-6 md:p-8 space-y-6 max-h-[80vh] overflow-y-auto">
          <div className={`p-4 border rounded-lg ${
            ...
            <div className="flex items-start gap-3">
              ...
              <div>
                ...
                <p className={`text-xs mt-1 leading-relaxed ${isDark ? 'text-[#D1B8BC]' : 'text-[#5C2B32]'}`}>
          ...
          <div>
            <h3 className={`text-xs font-semibold uppercase tracking-wider mb-3 ${isDark ? 'text-[#D1B8BC]' : 'text-[#8C2A38]'}`}>
              {isTa ? 'திட்டமிடப்பட்ட போர்டல் இணைப்புகள் (எதிர்கால கட்டங்கள்)' : 'Planned Gateway Integrations (Future Phases)'}
            </h3>
            <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
              <div className={`p-4 border rounded-lg ${isDark ? 'bg-[#150709] border-[#4D1E27]' : 'bg-[#FAF7F2] border-[#E2D5B8]'}`}>
                <div className={`flex items-center gap-2 mb-2 ${isDark ? 'text-white' : 'text-[#2B1015]'}`}>
          ...
          <div className={`p-4 border rounded-lg ${isDark ? 'bg-[#2E1218] border-[#4D1E27]' : 'bg-[#F2EAE0] border-[#E2D5B8]'}`}>
            <h4 className={`text-xs font-semibold mb-2 ${isDark ? 'text-white' : 'text-[#2B1015]'}`}>
        ...
        <div className={`flex items-center justify-between px-6 py-4 border-t ${
          ...
          <span className={`text-xs ${isDark ? 'text-[#D1B8BC]' : 'text-[#5C2B32]'}`}>
