    ...
    <div className={`min-h-screen py-12 lg:py-20 transition-colors duration-300 ${
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 space-y-16">
        ...
        <div className={`border rounded-2xl p-8 lg:p-12 shadow-xl grid grid-cols-1 lg:grid-cols-12 gap-8 items-center ${
          isDark 
            ? 'bg-[#241E0F] text-[#FAF3EB] border-[#4A3B18]' 
          ...
          <div className="lg:col-span-8 space-y-4">
            ...
            <p className={`text-xs sm:text-sm leading-relaxed ${isDark ? 'text-[#D8CCA8]/80' : 'text-[#61502C]/80'}`}>
          ...
          <div className={`lg:col-span-4 p-6 border rounded-xl text-center space-y-2 ${
            ...
            <h3 className={`text-xs font-mono uppercase tracking-widest pt-2 ${isDark ? 'text-[#D8CCA8]' : 'text-[#B8860B]'}`}>
        ...
        <div className="space-y-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            <div className={`p-6 border rounded-xl space-y-3 shadow-sm ${
              ...
              <h3 className={`text-base font-bold ${isDark ? 'text-white' : 'text-[#1C1810]'}`}>{t.about.collabTitle}</h3>
            ...
            <div className={`p-6 border rounded-xl space-y-3 shadow-sm ${
              ...
              <h3 className={`text-base font-bold ${isDark ? 'text-white' : 'text-[#1C1810]'}`}>{t.about.accountabilityTitle}</h3>
              <p className={`text-xs leading-relaxed ${isDark ? 'text-[#D8CCA8]' : 'text-[#61502C]'}`}>
            ...
            <div className={`p-6 border rounded-xl space-y-3 shadow-sm ${
              ...
              <h3 className={`text-base font-bold ${isDark ? 'text-white' : 'text-[#1C1810]'}`}>{t.about.knowledgeTitle}</h3>
              <p className={`text-xs leading-relaxed ${isDark ? 'text-[#D8CCA8]' : 'text-[#61502C]'}`}>
        ...
        <div className={`p-8 border rounded-2xl space-y-6 ${
          ...
          <div className="max-w-2xl">
            <h3 className={`text-xl font-bold ${isDark ? 'text-white' : 'text-[#1C1810]'}`}>{t.about.commTitle}</h3>
            <p className={`text-xs sm:text-sm mt-1 leading-relaxed ${isDark ? 'text-[#D8CCA8]' : 'text-[#61502C]'}`}>
              {t.about.commSub}
            </p>
          </div>
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4 text-xs">
            <div className={`p-4 rounded-lg border ${
              isDark ? 'bg-[#100D06] border-[#4A3B18]' : 'bg-white border-[#E2D5B8]'
            }`}>
              <strong className="block text-[#D4AF37] mb-1">{isTa ? 'எளிய & களப்பணி சார்ந்தது' : 'Simple & Grounded'}</strong>
              <span className={isDark ? 'text-[#D8CCA8]' : 'text-[#61502C]'}>
        ...
        <div className={`border rounded-2xl p-8 lg:p-12 space-y-6 ${
          ...
          <div className="pt-4 border-t border-[#4A3B18] flex flex-wrap items-center justify-between gap-4">
            <div>
              <span className="text-xs font-bold text-white block">AEGAM TRUST Leadership</span>
              <span className="text-[11px] text-[#D8CCA8]">Tamil Nadu, India</span>
            </div>
            ...
            <div className="flex items-center gap-3">
              <button
                ...
                className={`px-4 py-2 font-bold text-xs rounded transition-colors ${
                  isDark ? 'bg-[#C5A059] text-[#18140B] hover:bg-[#D4AF37]' : 'bg-[#D4AF37] text-[#1C1810] hover:bg-[#E5C158]'
                }`}
              >
              ...
              <button
                ...
                className={`px-4 py-2 border text-xs font-semibold rounded transition-colors ${
                  isDark ? 'bg-[#241E0F] border-[#4A3B18] text-[#D8CCA8] hover:text-white' : 'bg-white/10 border-white/20 text-white hover:bg-white/20'
                }`}
              >
                {t.about.getInTouch}
              </button>
